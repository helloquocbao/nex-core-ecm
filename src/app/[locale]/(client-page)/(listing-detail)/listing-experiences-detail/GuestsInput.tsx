...
import ClearDataButton from "@/app/[locale]/(client-page)/(client-components)/(HeroSearchForm)/ClearDataButton";
import { GuestsObject } from "@/app/[locale]/(client-page)/(client-components)/type";
