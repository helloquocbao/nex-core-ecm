...
import ClearDataButton from "@/app/(client-page)/(client-components)/(HeroSearchForm)/ClearDataButton";
import { GuestsObject } from "@/app/(client-page)/(client-components)/type";
